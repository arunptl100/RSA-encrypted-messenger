        ...
        if(inputLine.toUpperCase().equals("ENCRYPT")){
          ...
          try{
            ...
            if((getIndexOfId(recipient_id)) < 0){
              ...
              //read in the encrypted digital signature also sent by the client
              BigInteger[] digsig = (BigInteger[]) in.readObject();
              ...
              //send the recipient the digital signature
              msg_recipient.out.writeObject(digsig);

              System.out.println(server.GenConsoleMessage("Sending client " + recipient_id) + " ciphertext and digital signature  " +
              ...
              //including the senders public key, to allow for decrypting of the digital signature
              clientpkey senderData = new clientpkey(this.pubkey_n, this.pubkey_e);
